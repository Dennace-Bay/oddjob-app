...
const CONFIGS: Record<string, ServiceConfig> = {
  ...
  "Painting": {
    sizes: [
      { label: "Small (touch-up / accent wall)", hours: 2 },
      { label: "Single room",                    hours: 4 },
      { label: "Multiple rooms",                 hours: 6 },
      { label: "Large job / full interior",      hours: 8 },
    ],
    addOns: [
      { id: "primer",      label: "Primer coat",          hours: 1 },
      { id: "second_coat", label: "Second coat",          hours: 2 },
      { id: "sanding",     label: "Sanding / prep",       hours: 1 },
      { id: "trim",        label: "Trim & baseboards",    hours: 1 },
      { id: "ceiling",     label: "High walls / ceiling", hours: 1 },
    ],
    hasDisposal: false,
    supplies: [
